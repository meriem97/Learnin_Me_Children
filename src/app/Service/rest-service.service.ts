...
export class RestServiceService {
  ...
  verifUser(username:any,password:any):Observable<any>{
    ...
    console.log(body)
    return this.httpClient.post("http://127.0.0.1/PFE/User/login.php",body);
  }
  //Admin
  ...
  public getAllAdmins()
  {
    return this.httpClient.get("http://127.0.0.1/PFE/admin/ListeAdmin.php",{headers : this.getHeader()});
  }

  public deleteAdmin(username : string)
  {
    return this.httpClient.delete("http://127.0.0.1/PFE/admin/DeleteAdmin.php?username=" + username,{headers : this.getHeader(), responseType : "text"});
  }

  //Course
  public getAllCourses()
  {
    return this.httpClient.get("http://127.0.0.1/PFE/Course/ListeCourse.php",{headers : this.getHeader()});
  }
  ...
  public getAllUsers()
  {
    return this.httpClient.get("http://127.0.0.1/PFE/User/ListeUser.php",{headers : this.getHeader()});
  }
  ...
  {
    return this.httpClient.delete("http://127.0.0.1/PFE/User/Deleteuser.php?username=" + username,{headers : this.getHeader(), responseType : "text"});
  }

  //Instructor
  public getAllInstructors()
  {
    return this.httpClient.get("http://127.0.0.1/PFE/Instructor/ListeInstructor.php", { headers : this.getHeader()});
  }
  ...
  {
    return this.httpClient.delete("http://127.0.0.1/PFE/Instructor/DeleteInstructor.php?username=" + username,{ headers : this.getHeader(), responseType : "text"});
  }
  ...
  {
    return this.httpClient.get("http://127.0.0.1/PFE/session/ListeSession.php",{headers : this.getHeader()});
  }
  ...
  {
    let url : string = 'http://127.0.0.1/PFE/session/DeleteSession.php?id=' + id;
